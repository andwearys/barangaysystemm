...
Object[] cols = null;
    ...
    public Residents() {
        ...
        showTime();
        UsersTable();
        String lbl = "<html>" + "<center>" + "TRASH" + "</center>" +"</html>";
    ...
    private void cmdArchiveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdArchiveActionPerformed
        // TODO add your handling code here:
         int row = tblResidents.getSelectedRow();
        if(tblResidents.isRowSelected(row)==true){
        int selectedOption = JOptionPane.showConfirmDialog(null, "Are you sure you want to delete this resident?", "Barangay System",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
        ...
        lblSelectedGender.setText(":");
        lblSelectedResidentImage.setIcon(null);
        JOptionPane.showMessageDialog(null, "Resident Successfully Deleted.","Barangay System",JOptionPane.INFORMATION_MESSAGE);
        }catch(Exception e){
        }
        }
        }else{
        JOptionPane.showMessageDialog(null, "Select Resident you want to Delete","Barangay System",JOptionPane.INFORMATION_MESSAGE);
        }
